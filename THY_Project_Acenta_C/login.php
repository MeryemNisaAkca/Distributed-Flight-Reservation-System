...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (sqlsrv_has_rows($stmt)) {
        ...
        if (password_verify($password, $row['PassHash'])) {
            ...
            // --- İZOLASYON İÇİN EKLENEN EN KRİTİK SATIR ---
            // Eğer giren kişi CompanyOwner ise, onun şirket ID'sini hafızaya alıyoruz.
            // Passenger ise bu değer NULL olacaktır (Tam istediğimiz gibi).
