<?php
// Bu kod Acente tarafında çalışır. Yerel veritabanına BAĞLANMAZ.
// PNR kodlarını Merkez API'sine gönderir ve yolcu listesini JSON olarak geri alır.



// --- KURAL 3: YAPI İZOLASYONU ---
// Acentaya özel ayarları çek. Bu dosya her acentada farklıdır.
...
// ---------------------------------
session_start();
// URL'den gelen rezervasyon detaylarını al
$pnr = $_GET['pnr'] ?? '';
