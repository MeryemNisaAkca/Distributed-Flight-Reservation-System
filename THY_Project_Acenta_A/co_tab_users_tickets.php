...
$sqlTickets = "
    SELECT 
        ...
        ISNULL(T.TicketStatus, 'Used') as TicketStatus, T.CheckInStatus, T.SeatNo, T.MealID, T.BaggageID,
...
// Today's Revenue (Sadece Bugünün Kazancı - İptaller Düşülmüş)
$sqlTodayRevenue = "
    SELECT 
...
function filterTickets(status) {
    const btns = {
        ...
        'Used': document.getElementById('btn-t-active'),
